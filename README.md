...
- To include folders that start with an underscore in your gh-pages site,
  assign a `1` to `NO_JEKYLL`. This is already performed when using
  `DOCTR_VERSIONS_MENU` so you don't need to set both.
